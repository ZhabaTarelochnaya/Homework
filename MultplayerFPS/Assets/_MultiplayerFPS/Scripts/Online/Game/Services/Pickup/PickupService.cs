...
namespace _MultiplayerFPS.Scripts.Services
{
    ...
    {
        readonly float _rangeThreshold;
        ...
        readonly Dictionary<uint, Pickup> _activePickups = new();
        ...
        public PickupService(Transform[] spawnPoints, IStateService stateService)
        {
            ...
            _rangeThreshold = _playerConfig.PickupRange * 0.1f;
            _pool = configService
                .GetAll<PickupConfig>()
        ...
        public void Spawn(PickupName name)
        {
            ...
            _activePickups.Add(pickup.netId, pickup);
        }
        ...
        {
            if (!_activePickups.TryGetValue(itemNetId, out var pickup)) return false;
            
            var player = _stateService.GetPlayerState(playerNetId);
            var range = _playerConfig.PickupRange + _rangeThreshold;
            ...
            _activePickups.Remove(itemNetId);
